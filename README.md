...
This project uses [Drizzle ORM](https://orm.drizzle.team/) with [Cloudflare D1](https://developers.cloudflare.com/d1/) (SQLite-based). Drizzle provides type-safe queries while D1 gives us a serverless SQL database at the edge.
